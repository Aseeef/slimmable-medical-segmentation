...
@register_config
class BracsDuckNet34_uf1_Config_Predict(BaseConfig):
    ...
    def __init__(self,):
        ...
        # Testing
        self.test_data_folder = r'/projectnb/ec523/projects/Team_A+/larynx_transfer_learning/github_branch/LarynxDataset/LarynxDataset/test'
        ...
        self.is_testing = True #Using model predict
