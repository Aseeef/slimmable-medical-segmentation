...
@register_config
class LSEDuckNet_uf1_2_predict_config(BaseConfig):
    ...
    def __init__(self,):
        ...
        self.load_ckpt_path = '/projectnb/ec523/projects/Team_A+/larynx_transfer_learning/github_branch/save/LSEducknet_34_uf1_2/best.pth'  
