...
@register_config
class LSEDuckNet_predict_config(BaseConfig):
    ...
    def __init__(self,):
        ...
        self.load_ckpt_path = '/projectnb/ec523/projects/Team_A+/larynx_transfer_learning/github_branch/save/LSEducknet_34/best.pth'  
