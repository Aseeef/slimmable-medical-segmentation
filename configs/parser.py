...
def get_parser():
    ...
    parser.add_argument('--num_channel', type=int, default=None, 
        help='number of input channel for a given dataset')
    parser.add_argument('--use_test_set', action='store_true', default=None,
    ...
    parser.add_argument('--base_channel', type=int, default=None, 
        help='base channel number for UNet and DUCKNet')
    ...
    # Validating
    parser.add_argument('--metrics', type=list, default=None, 
        help='list of validating metrics, default is `["dice"]`')    
    ...
    parser.add_argument('--val_img_stride', type=int, default=None, 
        help="There may exist various sizes of images which are NOT evenly divisible by model's stride. Resize them to be \
            compatible with model's stride and resize back after forward path druing validation if you need it.")
    ...
    parser.add_argument('--colormap', type=str, default=None, choices = ['random', 'custom'],
        help='choose which colormap of visulization you want to use')
    parser.add_argument('--colormap_path', type=str, default=None,
        help='path to load a predefined colormap if existed')
    ...
    parser.add_argument('--reduction', type=float, default=None, 
        help='method of reduction for cross entropy loss')
    ...
    parser.add_argument('--destroy_ddp_process', action='store_false', default=None, 
        help='whether to destroy DDP process or not at the end of training (default: True)')
