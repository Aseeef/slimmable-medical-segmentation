...
@register_config
class LSEDuckNet_uf1_predict_config(BaseConfig):

    def __init__(self,):
        super().__init__()
        # Config name; used for save path
        self.save_dir = '/projectnb/ec523/projects/Team_A+/larynx_transfer_learning/github_branch/save/LSEducknet_34_uf1'
        ...
        self.test_data_folder = '/projectnb/ec523/projects/Team_A+/larynx_transfer_learning/github_branch/LSEDataset/LSEDataset/test/images'
        self.load_ckpt_path = '/projectnb/ec523/projects/Team_A+/larynx_transfer_learning/github_branch/save/LSEducknet_34_uf1/last.pth'  
