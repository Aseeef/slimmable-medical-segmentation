...
@register_model()
class SlimLSEDuckNet_UF1_2(nn.Module):
    def __init__(self, slim_width_mult_list: List[float], num_class=1, n_channel=3, base_channel=34, act_type='relu'):
        ...
        self.down_stage2 = SlimmableDownsampleBlock(slim_width_mult_list, base_channel_list * 2, base_channel_list * 4,
                                                    act_type)
        self.down_stage3 = SlimmableDownsampleBlock(slim_width_mult_list, base_channel_list * 4, base_channel_list * 8,
                                                    act_type)
        self.down_stage4 = SlimmableDownsampleBlock(slim_width_mult_list, base_channel_list * 8, base_channel_list * 16,
                                                    act_type)
        self.down_stage5 = SlimmableDownsampleBlock(slim_width_mult_list, base_channel_list * 16,
                                                    base_channel_list * 32, act_type)
        ...
        self.up_stage5 = SlimmableUpsampleBlock(slim_width_mult_list, base_channel_list * 16, base_channel_list * 8,
                                                act_type)
        self.up_stage4 = SlimmableUpsampleBlock(slim_width_mult_list, base_channel_list * 8, base_channel_list * 4,
                                                act_type)
        self.up_stage3 = SlimmableUpsampleBlock(slim_width_mult_list, base_channel_list * 4, base_channel_list * 2,
                                                act_type)
        ...
        self.up_stage2 = SlimmableUpsampleBlock(slim_width_mult_list, base_channel_list * 2, base_channel_list,
                                                act_type)
        self.up_stage1_lse = SlimmableUpsampleBlock(slim_width_mult_list, base_channel_list, base_channel_list, act_type)

        # 1×1 conv; output dim fixed
        self.seg_head_lse = slimmable_conv1x1(slim_width_mult_list, base_channel_list,
                                          [num_class for _ in range(len(slim_width_mult_list))])
        ...
        print("Model SlimLSEDuckNet_UF1_2: Please review below to ensure proper architecture and training updates")
        print('----------------------------------------------------------------------------------------')
...
class SlimmableDUCK(nn.Module):
    def __init__(self, width_mult_list, in_channels_list, out_channels_list, act_type, filter_size=6 + 1):
        ...
        self.branch6 = SlimmableSeparatedBlock(width_mult_list, in_channels_list, out_channels_list, filter_size,
                                               act_type)
...
class SlimmableSeparatedBlock(nn.Sequential):
    def __init__(self, width_mult_list, in_channels_list, out_channels_list, filter_size, act_type):
        super().__init__(
            SlimmableConvBNAct(width_mult_list, in_channels_list, out_channels_list, (1, filter_size),
                               act_type=act_type),
            SlimmableConvBNAct(width_mult_list, out_channels_list, out_channels_list, (filter_size, 1),
                               act_type=act_type),
        )