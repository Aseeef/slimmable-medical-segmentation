...
@register_model()
class BRACSDuckNet(nn.Module): #Changed num_class to 12, since there are 12 classes and 1 "everything else"
    def __init__(self, num_class=1, n_channel=3, base_channel=17, act_type='relu', best_weights_path = r'/projectnb/ec523/projects/Team_A+/larynx_transfer_learning/medical-segmentation-pytorch/save/best.pth'):
        ...
        print("[INFO] Loaded pretrained weights (excluding seg_head).")
        ...
        self.seg_head.requires_grad = True
